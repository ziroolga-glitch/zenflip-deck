...
const Deck: React.FC<DeckProps> = ({ cards }) => {
  ...
  // Triple cards for seamless infinite feel
  ...
  useEffect(() => {
    ...
    // Initial positioning to the middle section for infinite effect
    ...
    const handleScroll = () => {
      ...
      // Silent jump to create infinite loop without visual flicker
  ...
  const scrollManual = (direction: 'left' | 'right') => {
    if (scrollRef.current) {
      ...
      const cardWidth = 300 + gap; // Approximate card width for manual nav
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto px-4 md:px-12 py-1 md:py-2">
      ...
      {/* 
          ...
          - Removed 'snap-x' and 'snap-mandatory' to allow smooth, free movement.
          - 'overflow-x-auto' provides native momentum scrolling on mobile.
          - 'touch-pan-x' ensures vertical scrolling doesn't interfere.
      */}
      <div 
        ref={scrollRef}
        ...
        style={{ 
          ...
          scrollSnapType: 'none', // Explicitly disable snapping
        }}
      >
